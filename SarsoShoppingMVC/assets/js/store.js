...
$(document).ready(function() {
	...
	slider_owl(".related-product", 1, 2, 5, 5, 20);
    ...
    $(".closeqv").on("click", function() {
        $(".quickview-wrapper, .modal-backdrop").hide();
    });
	  $(".openqv").on("click", function() {
    ...
    if ($('.quantity').length > 0) {
        ...
        minus.on('click', function() {
            ...
            result.html(function(){
                return '$'+(item_number.val() * item_price.val().replace('Rs.', '')).toFixed(2);
            });
        ...
        plus.on('click', function() {
            ...
            var result =  item_cart.children('.total-price');
            result.html(function(){
                return 'Rs'+(item_number.val() * item_price.val().replace('Rs', '')).toFixed(2);
            });
        });
        $('.item_cart').each(function() {
        var answer = (parseInt($(this).children('.product-quantity').find('input').val()) * $(this).children('.produc-price').find('input').val().replace('Rs', '')).toFixed(2);
        $(this).children('.total-price').html('Rs' + answer);
        });
        ...
        $(this).children('.product-quantity').find('input').change(function() {
          ...
          $(this).parents('.item_cart').children('.total-price').html('Rs' + answer);
        });
        });
    }
    ...
    slider_images.trigger("to.owl.carousel", [number_active, 5, true]);
    ...
    slidecount = 1;
    $('.slider-dot-images .owl-item').each(function() {
